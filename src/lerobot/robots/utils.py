...
def make_robot_from_config(config: RobotConfig) -> Robot:
    ...
    elif config.type == "custom_manipulator":
        from .custom_manipulator.custom_manipulator import CustomManipulator

        return CustomManipulator(config)
